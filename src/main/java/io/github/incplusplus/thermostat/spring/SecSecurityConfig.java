...
import io.github.incplusplus.thermostat.security.CustomRememberMeServices;
...
@Configuration
@ComponentScan(basePackages = { "io.github.incplusplus.thermostat.security" })
...
public class SecSecurityConfig extends WebSecurityConfigurerAdapter
{
    ...
    protected void configure(final HttpSecurity http) throws Exception
    {
        ...
        http
            .csrf().disable()
            .authorizeRequests()
                .antMatchers("/v2/**","/swagger-ui.html", "/swagger-resources/**", "/webjars/**", "/login*","/login*", "/logout*", "/signin/**", "/signup/**", "/customLogin",
